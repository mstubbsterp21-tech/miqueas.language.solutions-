  ...
  return (
    <div className="mx-auto max-w-6xl px-5 md:px-8 py-20">
      ...
      <p className="mb-10 max-w-3xl text-base md:text-lg" style={{ color: '#5f5f5f' }}>
        Miqueas Language Solutions was built to offer clients the kind of professional support that still feels human.
        The goal is simple: provide language access with care, clarity, and strong attention to the people involved.
      </p>

      {/* Story section */}
      <div
        className="mb-10 rounded-[2rem] border p-7 shadow-sm"
      ...
      >
        ...
        <div
          className="mt-5 space-y-4 text-sm leading-7 md:text-base"
          style={{ color: '#5f5f5f' }}
        >
          <p>
            The work behind Miqueas Language Solutions grew out of years of language development, community connection,
            and professional interpreting experience. After beginning ASL study in 2013 and entering the field
            professionally in 2019, the mission became clearer with time: help reduce communication barriers and
            support more equitable access between Deaf and hearing worlds.
          </p>
          <p>
            Today, that mission shows up through dependable service, ongoing growth, and a commitment to meeting
            clients and consumers with respect. The result is a business that values both professional standards and
            genuine care.
          </p>
        </div>
      </div>
          ...
          {values.map((item) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <h4 className="font-semibold" style={{ color: palette.charcoal }}>
                    {item.title}
                  </h4>
      ...
      >
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          {[
            ...
            >
              <p className="text-sm leading-7" style={{ color: '#5f5f5f' }}>
                “{quote}”
              </p>
            </div>
          ))}
