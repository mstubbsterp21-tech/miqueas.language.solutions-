  ...
  return (
    <div className="mx-auto max-w-6xl px-5 md:px-8 py-20">
      ...
      <p className="mb-10 max-w-3xl text-base md:text-lg" style={{ color: "#5f5f5f" }}>
        Whether the need is virtual, on-site, or recorded, services are designed to make communication access feel smoother,
        more human, and more dependable.
      </p>
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
        {serviceCards.map((card) => {
          ...
          return (
            <div key={card.title} className="rounded-[1.75rem] border p-6 shadow-sm"
      ...
      <div className="mt-14 grid gap-8 lg:grid-cols-[1fr_1.15fr]">
        ...
        <div className="rounded-[2rem] border p-7 shadow-sm"
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            {specialtyCards.map((item) => {
              ...
              return (
                <div key={item.title} className="flex items-center gap-3 rounded-2xl p-4"
                     style={{ backgroundColor: palette.softGray }}>
        ...
        <div className="rounded-[2rem] p-7 shadow-sm" style={{ backgroundColor: palette.charcoal }}>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-white/80">
            Miqueas Language Solutions is designed for clients who want professional support without feeling shuffled through
            a generic system. Every inquiry is handled with attention to logistics, communication needs, and assignment fit.
          </p>
