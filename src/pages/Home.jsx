  ...
  return (
    <div className="mx-auto max-w-6xl px-5 md:px-8 py-20">
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        <div className="mb-5 inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm"
        ...
        <h1 className="max-w-3xl text-4xl font-bold tracking-tight md:text-6xl" style={{ color: palette.charcoal }}>
        ...
        <p className="mt-6 max-w-2xl text-lg md:text-xl" style={{ color: "#5f5f5f" }}>
          Miqueas Language Solutions provides ASL ↔ English interpreting and ASL video translation services with the care,
          responsiveness, and professionalism clients deserve.
        </p>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          {[
            ...
            <div key={stat} className="rounded-3xl border p-5 shadow-sm"
